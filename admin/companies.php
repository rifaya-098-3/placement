...
$result=mysqli_query($conn,"SELECT * FROM companies ORDER BY company_id DESC");
...
<td><a href="delete_company.php?id=<?php echo $row['company_id']; ?>" class="table-action delete">Delete</a></td>
</tr>
<?php } ?>
